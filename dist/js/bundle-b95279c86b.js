...
},{"jquery":39,"underscore":40}],4:[function(require,module,exports){
...
},{"./_to-absolute-index":31,"./_to-iobject":33,"./_to-length":34}],9:[function(require,module,exports){
...
function deleteResident(resident, callback) {
  var request = new util.Request('/a/residentController/deleteResident');
  ...
  request.postJSON(options, function (err, data) {
    if (err) {
      console.error(err);
      callback(err);
...
},{"../common/util":43,"underscore":40}],42:[function(require,module,exports){
'use strict';

var _require = require('../components/breadcrumb'),
    BreadcrumbView = _require.BreadcrumbView;
...
function createRouterClass(subRouters) {
  ...
  subRouters.forEach(function (subRouter) {
    var subRoutes = generateRoutes(subRouter);
    var subRouteMethods = generateRouteMethods(subRouter);

    _.extend(routerInfo.routes, subRoutes);
    _.extend(routerInfo, subRouteMethods);
  });

  var Router = Backbone.Router.extend(routerInfo);
...
function generateRouteMethods(router) {
  var methods = {};
  router.routes.forEach(function (route) {
    var methodName = generateRouteMethodName(route);
...
module.exports = {
  createRouterClass: createRouterClass
};

},{"../components/breadcrumb":44,"backbone":3,"underscore":40}],43:[function(require,module,exports){
'use strict';
...
Request.parseQueryString = function (queryString) {
  ...
  var parameters = {};
  for (var parameterIndex in parameterList) {
...
function postJSON(url, data, callback) {
  $.ajax({
    ...
    error: function error(req, message, e) {
      callback({
        req: req,
        message: message,
        e: e
...
function formatDate(date) {
  return date.getFullYear() + '-' + paddingZero(date.getMonth() + 1, 2) + '-' + paddingZero(date.getDate(), 2);
}
...
},{"babel-runtime/core-js/json/stringify":1}],44:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $breadcrumbTemplate = $('#am-template-component-breadcrumb');
...
var BreadcrumbView = Backbone.View.extend({
  ...
  push: function push(location) {
    var locations = this.modle.get('locations');
...
},{"backbone":3,"underscore":40}],45:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $authCellTemplate = $('#am-template-component-auth-cell');

var AuthCellView = Backbone.View.extend({
  tagName: 'td',
  ...
  render: function render() {
    var property = this._options.property;
...
module.exports = {
  AuthCellView: AuthCellView
};

},{"backbone":3,"underscore":40}],46:[function(require,module,exports){
'use strict';

var _require = require('../../checkbox'),
    CheckBoxView = _require.CheckBoxView;

var Backbone = require('backbone');
var _ = require('underscore');

var $checkboxCellTemplate = $('#am-template-component-checkbox-cell');

var CheckBoxCellView = Backbone.View.extend({
  tagName: 'td',
  ...
  initCheckbox: function initCheckbox() {
    ...
    this.listenTo(this._checkBox, 'change:checked', function (checked) {
      _this._options.model.set(property, checked);
    });
  }
});

module.exports = {
  CheckBoxCellView: CheckBoxCellView
};

},{"../../checkbox":50,"backbone":3,"underscore":40}],47:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $opCellTemplate = $('#am-template-component-op-cell');

var OpCellView = Backbone.View.extend({
  tagName: 'td',
  events: {
...
module.exports = {
  OpCellView: OpCellView
};

},{"backbone":3,"underscore":40}],48:[function(require,module,exports){
'use strict';

var _require = require('../../select'),
    SelectView = _require.SelectView;

var Backbone = require('backbone');
var _ = require('underscore');

var $stringListCellTemplate = $('#am-template-component-string-list-cell');

var StringListCellView = Backbone.View.extend({
  tagName: 'td',
  ...
  initStringList: function initStringList() {
    var model = this._options.model;
    var property = this._options.property;
    var combinedString = model.get(property);

    var items = combinedString.split(',').map(function (line, lineIndex) {
      return {
        value: lineIndex,
        text: line
      };
...
module.exports = {
  StringListCellView: StringListCellView
};

},{"../../select":54,"backbone":3,"underscore":40}],49:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $textCellTemplate = $('#am-template-component-text-cell');

var TextCellView = Backbone.View.extend({
  tagName: 'td',
...
},{"backbone":3,"underscore":40}],50:[function(require,module,exports){
'use strict';
...
},{"backbone":3}],51:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $datePickerTemplate = $('#am-template-component-datepicker');

var DatePickerModel = Backbone.Model.extend({
  defaults: {
    language: 'zh-CN'
  }
});
...
},{"backbone":3,"underscore":40}],52:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $navBarTemplate = $('#am-template-component-nav-bar');
...
},{"backbone":3,"underscore":40}],53:[function(require,module,exports){
'use strict';
...
var $pageBarTemplate = $('#am-template-component-page-bar');
...
var PageBarView = Backbone.View.extend({
  ...
  initPageSizeSelect: function initPageSizeSelect() {
    var _this = this;
    ...
    this.listenTo(this._pageSizeSelect, 'change:value', function (value) {
      var pageSize = Number(value);
      _this.trigger('change:pageSize', pageSize);
    });
  },
  ...
  nextPage: function nextPage() {
    var currentPage = this.model.get('currentPage');
    var maxPage = this.model.get('maxPage');
  ...
  jumpTo: function jumpTo() {
    var destinationPage = Number(this.$el.find('.jump-page').val());
    var currentPage = this.model.get('currentPage');
    var maxPage = this.model.get('maxPage');
...
},{"../select":54,"backbone":3,"underscore":40}],54:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $selectTemplate = $('#am-template-component-select');
...
var SelectView = Backbone.View.extend({
  ...
  initMapper: function initMapper() {
  ...
  selectItem: function selectItem(e) {
    ...
    var mapper = this.model.get('mapper');
    var text = mapper[value];
...
},{"backbone":3,"underscore":40}],55:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $sideBarTemplate = $('#am-template-component-side-bar');
...
},{"backbone":3,"underscore":40}],56:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $switchTemplate = $('#am-template-component-switch');
...
},{"backbone":3,"underscore":40}],57:[function(require,module,exports){
'use strict';

var Backbone = require('backbone');
var _ = require('underscore');

var $tabBarTemplate = $('#am-template-component-tab-bar');
...
var TabBarView = Backbone.View.extend({
  ...
  activeTabBar: function activeTabBar() {
...
},{"backbone":3,"underscore":40}],58:[function(require,module,exports){
'use strict';

var _require = require('../cell/text'),
    TextCellView = _require.TextCellView;

var _require2 = require('../cell/checkbox'),
    CheckBoxCellView = _require2.CheckBoxCellView;

var _require3 = require('../cell/auth'),
    AuthCellView = _require3.AuthCellView;

var _require4 = require('../cell/op'),
    OpCellView = _require4.OpCellView;

var _require5 = require('../cell/string-list'),
    StringListCellView = _require5.StringListCellView;

var _require6 = require('../checkbox'),
    CheckBoxView = _require6.CheckBoxView;

var Backbone = require('backbone');
var _ = require('underscore');

var $tableTemplate = $('#am-template-component-table');
...
var TableView = Backbone.View.extend({
  ...
  render: function render() {
    ...
    this._processedCollection.forEach(function (element, elementIndex) {
      var $row = _this.$el.find('tr[data-index="' + elementIndex + '"]');

      _this._options.columns.forEach(function (column) {
        var cellType = column.type ? column.type : 'text';

        if (column.property) {
          var CellClass = CellClasses[cellType];
  ...
  initHeaderCheckBoxes: function initHeaderCheckBoxes() {
    var _this2 = this;

    this._options.columns.forEach(function (column) {
      var cellType = column.type ? column.type : 'text';
      var property = column.property;

      if (cellType === 'checkbox' && property) {
        _this2.createHeaderCheckBox(property);
      }
    });
  },
  createHeaderCheckBox: function createHeaderCheckBox(property) {
    var _this3 = this;

    var $checkbox = this.$el.find('th[data-property=' + property + '] .am-checkbox');
    ...
    this.listenTo(checkbox, 'change:checked', function (checked) {
      _this3.selectAll(property, checked);
    });
  },
  selectAll: function selectAll(property, checked) {
    this._processedCollection.forEach(function (element) {
...
},{"../cell/auth":45,"../cell/checkbox":46,"../cell/op":47,"../cell/string-list":48,"../cell/text":49,"../checkbox":50,"backbone":3,"underscore":40}],59:[function(require,module,exports){
'use strict';

var _require = require('./routers'),
    Router = _require.Router;

var _require2 = require('./components/nav-bar'),
    NavBarView = _require2.NavBarView;

var _require3 = require('./components/side-bar'),
    SideBarView = _require3.SideBarView;
...
var DEFAULT_DATE = new Date(1900, 0, 1);
...
var ResidentCollection = Backbone.Collection.extend({
  model: Resident
});
...
},{"backbone":3}],61:[function(require,module,exports){
'use strict';
...
},{"backbone":3}],62:[function(require,module,exports){
'use strict';

var _require = require('../../components/tab-bar'),
    TabBarView = _require.TabBarView;
...
var $analysisPageTemplate = $('#am-template-page-analysis');
...
var AnalysisPage = Backbone.View.extend({
  tagName: 'div',
  className: 'container-fluid am-page am-config-page am-page-analysis-chart',
  events: {},
  template: _.template($analysisPageTemplate.html()),
  initialize: function initialize() {
  ...
  render: function render() {
    ...
    var roles = store.user.get('roles');
    var tabItems = UserTabs;
  ...
  onShow: function onShow() {
    this.onPageResize();
    this.renderPeoChart();
    this.renderPassChart();
    this.renderHomelessPeoChart();
    this.renderAgeChart();
  },
  renderPeoChart: function renderPeoChart() {
    var dom = this.$el.find('.analysis-peo-chart')[0];
    this._mypeoChart = echarts.init(dom);
    var Option = {
      title: {
        text: '人口分布',
        subtext: '中科奥森',
      ...
      series: [{
        ...
        data: [{ value: 10, name: '留守人口' }, { value: 15, name: '户籍人口' }, { value: 30, name: '境外人口' }, { value: 25, name: '流动人口' }, { value: 20, name: '其他' }]
      }]
    };
    this._mypeoChart.setOption(Option);
  },
  renderHomelessPeoChart: function renderHomelessPeoChart() {
    var dom = this.$el.find('.analysis-homeless-peo-chart')[0];
    this._myhomelesspeoChart = echarts.init(dom);
    var Option = {
      title: {
        text: '流动人口',
        subtext: '中科奥森'
      ...
      series: [{
        name: '2014年',
        type: 'line',
        data: [11, 11, 15, 13, 12, 13, 10, 9, 23, 12, 14, 16],
        markPoint: {
        ...
        name: '2015年',
        type: 'line',
        data: [13, 12, 22, 15, 13, 22, 20, 23, 17, 19, 20, 19],
        markPoint: {
          data: [{ type: 'max', name: '最大值' }, { type: 'min', name: '最小值' }]
        },
        markLine: {
        ...
        name: '2016年',
        type: 'line',
        data: [14, 17, 23, 10, 14, 27, 30, 13, 15, 17, 20, 13],
        markPoint: {
          data: [{ type: 'max', name: '最大值' }, { type: 'min', name: '最小值' }]
        },
        markLine: {
    ...
    this._myhomelesspeoChart.setOption(Option);
  },
  renderAgeChart: function renderAgeChart() {
    var dom = this.$el.find('.analysis-age-chart')[0];
    this._myageChart = echarts.init(dom);
    var Option = {
      title: {
        text: '人口年龄分布',
        subtext: '中科奥森'
    ...
    this._myageChart.setOption(Option);
  },
  renderPassChart: function renderPassChart() {
    var dom = this.$el.find('.analysis-pass-time-chart')[0];
    this._mypasstimeChart = echarts.init(dom);
    var dataMap = {};
    function dataFormatter(obj) {
      var pList = ['00:00', '01:00', '02:00', '03:00', '04:00', '05:00', '06:00', '07:00', '08:00', '09:00', '10:00', '11:00', '12:00', '13:00', '14:00', '15:00', '16:00', '17:00', '18:00', '19:00', '20:00', '21:00', '22:00', '23:00'];
      var temp = 0;
    ...
    var option = {
      timeline: {
        data: ['2016-09-01', '2016-10-01', '2016-11-01', '2016-12-01', '2017-01-01', '2017-02-01', '2017-03-01', '2017-04-01', '2017-05-01', '2017-06-01'],
        label: {
      ...
      options: [{
        ...
        title: { 'text': '2016-10通行记录' },
        series: [{ 'data': dataMap.dataGDP['2003'] }, { 'data': dataMap.dataFinancial['2003'] }, { 'data': dataMap.dataEstate['2003'] }, { 'data': dataMap.dataPI['2003'] }, { 'data': dataMap.dataSI['2003'] }, { 'data': dataMap.dataTI['2003'] }]
      }, {
        title: { 'text': '2016-11通行记录' },
        series: [{ 'data': dataMap.dataGDP['2004'] }, { 'data': dataMap.dataFinancial['2004'] }, { 'data': dataMap.dataEstate['2004'] }, { 'data': dataMap.dataPI['2004'] }, { 'data': dataMap.dataSI['2004'] }, { 'data': dataMap.dataTI['2004'] }]
      }, {
        title: { 'text': '2016-12通行记录' },
        series: [{ 'data': dataMap.dataGDP['2005'] }, { 'data': dataMap.dataFinancial['2005'] }, { 'data': dataMap.dataEstate['2005'] }, { 'data': dataMap.dataPI['2005'] }, { 'data': dataMap.dataSI['2005'] }, { 'data': dataMap.dataTI['2005'] }]
      }, {
        title: { 'text': '2017-01通行记录' },
        series: [{ 'data': dataMap.dataGDP['2006'] }, { 'data': dataMap.dataFinancial['2006'] }, { 'data': dataMap.dataEstate['2006'] }, { 'data': dataMap.dataPI['2006'] }, { 'data': dataMap.dataSI['2006'] }, { 'data': dataMap.dataTI['2006'] }]
      }, {
        title: { 'text': '2017-02通行记录' },
        series: [{ 'data': dataMap.dataGDP['2007'] }, { 'data': dataMap.dataFinancial['2007'] }, { 'data': dataMap.dataEstate['2007'] }, { 'data': dataMap.dataPI['2007'] }, { 'data': dataMap.dataSI['2007'] }, { 'data': dataMap.dataTI['2007'] }]
      }, {
        title: { 'text': '2017-03通行记录' },
        series: [{ 'data': dataMap.dataGDP['2008'] }, { 'data': dataMap.dataFinancial['2008'] }, { 'data': dataMap.dataEstate['2008'] }, { 'data': dataMap.dataPI['2008'] }, { 'data': dataMap.dataSI['2008'] }, { 'data': dataMap.dataTI['2008'] }]
      }, {
        title: { 'text': '2017-04通行记录' },
        series: [{ 'data': dataMap.dataGDP['2009'] }, { 'data': dataMap.dataFinancial['2009'] }, { 'data': dataMap.dataEstate['2009'] }, { 'data': dataMap.dataPI['2009'] }, { 'data': dataMap.dataSI['2009'] }, { 'data': dataMap.dataTI['2009'] }]
      }, {
        title: { 'text': '2017-05通行记录' },
        series: [{ 'data': dataMap.dataGDP['2010'] }, { 'data': dataMap.dataFinancial['2010'] }, { 'data': dataMap.dataEstate['2010'] }, { 'data': dataMap.dataPI['2010'] }, { 'data': dataMap.dataSI['2010'] }, { 'data': dataMap.dataTI['2010'] }]
      }, {
        title: { 'text': '2017-06通行记录' },
        series: [{ 'data': dataMap.dataGDP['2011'] }, { 'data': dataMap.dataFinancial['2011'] }, { 'data': dataMap.dataEstate['2011'] }, { 'data': dataMap.dataPI['2011'] }, { 'data': dataMap.dataSI['2011'] }, { 'data': dataMap.dataTI['2011'] }]
      }]
    };
    this._mypasstimeChart.setOption(option);
  },
  onPageResize: function onPageResize() {
    var controldivheight = this.$el.find('.analysis-chart')[0].clientWidth * 0.6;
    var divWidth = this.$el.find('.control-chart')[0].clientWidth;
    var divHeight = divWidth * 1.2;
    var chartWidth = divWidth;
    var chartHeight = divHeight;
    var changePie = chartHeight / this._oldHeight;

    if (chartWidth === this._oldWidth && chartHeight === this._oldHeight) {
      return;
    }

    var $controlchart = this.$el.find('.control-chart');
    $controlchart.css('height', controldivheight + 'px');

    var $peochart = this.$el.find('.analysis-peo-chart');
    $peochart.css('width', chartWidth + 'px');
    $peochart.css('height', chartHeight + 'px');
    var $homelesspeochart = this.$el.find('.analysis-homeless-peo-chart');
    $homelesspeochart.css('width', chartWidth + 'px');
    $homelesspeochart.css('height', chartHeight + 'px');
    var $agechart = this.$el.find('.analysis-age-chart');
    $agechart.css('width', chartWidth + 'px');
    $agechart.css('height', chartHeight + 'px');
    var $passtimechart = this.$el.find('.analysis-pass-time-chart');
    $passtimechart.css('width', chartWidth + 'px');
    $passtimechart.css('height', chartHeight + 'px');

    if (this._mypeoChart) {
      this._mypeoChart.resize();
    }
    if (this._myhomelesspeoChart) {
      this._myhomelesspeoChart.resize();
    }
    if (this._myageChart) {
      this._myageChart.resize();
    }
    if (this._mypasstimeChart) {
      this._mypasstimeChart.resize();
    }
...
var _require = require('../../models/resident'),
    Resident = _require.Resident,
    ResidentCollection = _require.ResidentCollection;

var _require2 = require('../../components/table'),
    TableView = _require2.TableView;

var _require3 = require('../../components/pagebar'),
    PageBarView = _require3.PageBarView,
    PageBarModel = _require3.PageBarModel;

var _require4 = require('../../components/select'),
    SelectView = _require4.SelectView;

var _require5 = require('../../components/date-picker'),
    DatePickerView = _require5.DatePickerView;

var residentApi = require('../../api/resident');
...
var $residentListPageTemplate = $('#am-template-page-resident-list');
...
var ResidentListPage = Backbone.View.extend({
  tagName: 'div',
  ...
  createCollection: function createCollection(datumList) {
    var models = datumList.map(function (datum) {
      return new Resident(datum);
    });

    return new ResidentCollection(models);
  },
  initSearchTypeSelect: function initSearchTypeSelect() {
  ...
  initResidentTable: function initResidentTable() {
  ...
  initPageBar: function initPageBar() {
  ...
  onPageSizeChanged: function onPageSizeChanged(pageSize) {
  ...
  removeResident: function removeResident(resident) {
    var _this = this;

    var ok = confirm('确认要删除该住户吗？');

    if (!ok) {
      return;
    }

    residentApi.deleteResident(resident, function (err, data) {
      if (err) {
        alert('删除住户失败');
      ...
      var currentPage = _this._pageBar.model.get('currentPage');
      var options = {
        pageNo: currentPage,
        pageSize: _this._pageSize
      };

      if (_this._searchOptions) {
        _this.refreshSearchResidents.call(_this, options);
      } else {
        _this.refreshResidents.call(_this, options);
      }
    });
  },
  refreshResidents: function refreshResidents(options, callback) {
    var _this2 = this;

    residentApi.getResidents(options, function (err, data) {
      ...
      var collection = _this2.createCollection(data.obj.list);
      _this2._table.setCollection(collection);
      _this2._table.render();

      _this2._pageBar.model.set('currentPage', options.pageNo);
      _this2._pageBar.model.set('maxPage', Math.ceil(data.obj.count / _this2._pageSize));
      _this2._pageBar.model.set('pageSize', Math.ceil(_this2._pageSize));

      _this2.$el.find('.label-total-count .number').html(data.obj.count);
  ...
  refreshSearchResidents: function refreshSearchResidents(options) {
    var _this3 = this;

    _.extend(this._searchOptions, options);
    var totalCount = this.$el.find('.label-total-count .number').html();
    this.refreshResidents(this._searchOptions, function (data) {
      _this3.$el.find('.label-search-count').show();
      _this3.$el.find('.label-search-count .number').html(data.obj.count);
      _this3.$el.find('.label-total-count .number').html(totalCount);
    });

    return false;
  },
  searchResidents: function searchResidents() {
  ...
  searchResidentsSince: function searchResidentsSince(startDate) {
    this.generateSearchOptions();
  ...
  generateSearchOptions: function generateSearchOptions() {
    var options = {};

    var searchType = this._selectSearchType.value();
    var searchContent = this.$el.find('.input-address').val();

    var startDate = this._startDatePicker.value();
    var endDate = this._endDatePicker.value();
  ...
  selectToday: function selectToday(e) {
    var today = new Date();
  ...
  selectYesterday: function selectYesterday(e) {
    var today = new Date();
  ...
  selectLastWeek: function selectLastWeek(e) {
    var today = new Date();
    var day = 6 - today.getDay();
  ...
  selectLastMonth: function selectLastMonth(e) {
    var today = new Date();
...
var _require2 = require('../../components/switch'),
    SwitchView = _require2.SwitchView;

var Backbone = require('backbone');
var _ = require('underscore');

var $residentRegisterPageTemplate = $('#am-template-page-resident-register');

var ResidentRegisterPage = Backbone.View.extend({
  tagName: 'div',
...
var $statisticPageTemplate = $('#am-template-page-statistic');

var StatisticPage = Backbone.View.extend({
  tagName: 'div',
  ...
  initiaSideBar: function initiaSideBar() {
    if ($('.am-sidebar').hasClass('simple')) {
      this.$el.addClass('simple');
    }
  },
  renderDeviceYearEchart: function renderDeviceYearEchart() {
    var dom = this.$el.find('.device-year')[0];
  ...
  renderDeviceSeasonEchart: function renderDeviceSeasonEchart() {
    var dom = this.$el.find('.device-season')[0];
  ...
  renderDeviceMonthEchart: function renderDeviceMonthEchart() {
    var dom = this.$el.find('.device-month')[0];
    ...
    var Option = {
      ...
      series: [{
        type: 'bar',
        smooth: true,
        data: [360, 357, 422, 353, 360, 357, 422, 353, 360, 357, 422, 353, 360, 357, 422, 353, 360, 357, 422, 353, 360, 357, 422, 353, 360, 357, 422, 353, 360, 357],
        itemStyle: {
          normal: {
            color: ['#4CBDFF']
          }
  ...
  renderFaceYearEchart: function renderFaceYearEchart() {
    var dom = this.$el.find('.face-year')[0];
  ...
  renderFaceSeasonEchart: function renderFaceSeasonEchart() {
    var dom = this.$el.find('.face-season')[0];
  ...
  renderFaceMonthEchart: function renderFaceMonthEchart() {
    var dom = this.$el.find('.face-month')[0];
  ...
  renderResidentYearEchart: function renderResidentYearEchart() {
    var dom = this.$el.find('.resident-year')[0];
  ...
  renderResidentSeasonEchart: function renderResidentSeasonEchart() {
    var dom = this.$el.find('.resident-season')[0];
  ...
  renderResidentMonthEchart: function renderResidentMonthEchart() {
    var dom = this.$el.find('.resident-month')[0];
  ...
  renderWarningYearEchart: function renderWarningYearEchart() {
    var dom = this.$el.find('.warning-year')[0];
  ...
  renderWarningSeasonEchart: function renderWarningSeasonEchart() {
    var dom = this.$el.find('.warning-season')[0];
  ...
  renderWarningMonthEchart: function renderWarningMonthEchart() {
    var dom = this.$el.find('.warning-month')[0];
  ...
  openDeviceYear: function openDeviceYear() {
  ...
  openDeviceSeason: function openDeviceSeason() {
  ...
  openDeviceMonth: function openDeviceMonth() {
    this.$el.find('.choose-device-year').hide();
  ...
  openResidentYear: function openResidentYear() {
  ...
  openResidentSeason: function openResidentSeason() {
  ...
  openResidentMonth: function openResidentMonth() {
    this.$el.find('.choose-resident-year').hide();
  ...
  openFaceYear: function openFaceYear() {
  ...
  openFaceSeason: function openFaceSeason() {
  ...
  openFaceMonth: function openFaceMonth() {
    this.$el.find('.choose-face-year').hide();
  ...
  openWarningYear: function openWarningYear() {
  ...
  openWarningSeason: function openWarningSeason() {
  ...
  openWarningMonth: function openWarningMonth() {
    this.$el.find('.choose-warning-year').hide();
...
var _require = require('../common/router'),
    createRouterClass = _require.createRouterClass;
...
var _require = require('../pages/resident-list'),
    ResidentListPage = _require.ResidentListPage;

var _require2 = require('../pages/resident-register'),
    ResidentRegisterPage = _require2.ResidentRegisterPage;
...
var _require = require('../pages/statistic'),
    StatisticPage = _require.StatisticPage;

var _require2 = require('../pages/analysis'),
    AnalysisPage = _require2.AnalysisPage;
...
var StandardWidth = 754;
var StandardHeight = 583;
...
var RegisterUsers = (0, _keys2.default)(ProvinceData).map(function (provinceName) {
  var value = ProvinceData[provinceName].items[1].value;
...
var ChinaMapOption = {
  ...
  series: [{
    ...
    markPoint: {
      clickable: true,
      symbol: 'circle',
      symbolSize: function symbolSize(v) {
        return Math.log(v);
      },
      effect: {
        shadowBlur: 0
